...
$SettingsCSV = @"
Name,Value
AbsolutePersistenceModule,Permanently Disabled
AccessSecuritySettings,Disabled
AutomaticBootSequence,M.2 Drive 1
BIOSPasswordAtBootDeviceList,Yes
BootUpNumLockStatus,On
CtrlPEnterMEBx,Disabled
EnhancedPowerSavingMode,Disabled
ErrorBootSequence,M.2 Drive 1
FastBoot,Enabled
ManageabilityControl,Disabled
POPChangeablebyUser,No
PrimaryBootSequence,M.2 Drive 1
SecurityChip2.0,Enabled
SmartPowerOn,Disabled
...
$csvPath = 'C:\Windows\Temp\764c656b-f1ea-40fb-bb0b-5645b5d49c19.csv'
$scriptPath = 'C:\Windows\Temp\736f767b-95ad-428e-a22a-70d7cc65b883.ps1'
Set-Content -Path $csvPath -Value $SettingsCSV -Encoding ascii
Set-Content -Path $scriptPath -Value $ModuleContent -Encoding ascii
& "$scriptPath" -SetSettings -CsvPath $csvPath -SupervisorPassword '<redacted>'
